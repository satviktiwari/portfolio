...
\runsubsection{Framework for CCTV Storage Optimization } \\
\vspace{\topsep} % Hacky fix for awkward extra vertical space
...
\runsubsection{Sag Measurement and Circle Fitting Algorithm} \\
\vspace{\topsep} % Hacky fix for awkward extra vertical space
...
\runsubsection{CRUD Application: User Interaction Platform} \\
\vspace{\topsep} % Hacky fix for awkward extra vertical space
